        ...
        if tab == "📊 Real-Time Monitoring":
            ...
            with col_left:
                ...
                if not df_readings.empty:
                    ...
                    st.plotly_chart(fig_ts, width="stretch", key="chart_ts")
            ...
            with col_right:
                ...
                st.plotly_chart(fig_loc, width="stretch", key="chart_loc")
            ...
            if total_anomalies > 0:
                ...
                with col_a:
                    ...
                    st.plotly_chart(fig_anom_type, width="stretch", key="chart_anom_type")
                ...
                with col_b:
                    ...
                    st.plotly_chart(fig_anom_loc, width="stretch", key="chart_anom_loc")
            ...
            for sensor_type in df_agg["sensor_type"].unique():
                ...
                st.plotly_chart(fig, width="stretch", key=f"chart_flink_{sensor_type}")
            ...
            with col_a:
                ...
                st.plotly_chart(fig_comp, width="stretch", key="chart_comp")
            ...
            with col_b:
                ...
                st.plotly_chart(fig_score, width="stretch", key="chart_score")
